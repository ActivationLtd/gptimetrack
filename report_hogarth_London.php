          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0"  id="<?php if ($_REQUEST[basic_table] != 'true') echo "report_table"; ?>" style="text-shadow: white 0.1em 0 0">
            <thead>
              <tr>
                ...
                <th>User Role</th>
                <th>Joining_date</th>
                <th>Hogarth Job ID</th>
                <th>Project/ DEPP ID</th>
                <th>Country</th>
                <th>Project Type<!--Billing Type--></th>
                <th>Client/Segment</th>
                <th>Production type</th>              
                <th><span style="width:80px; float:left">Task Date</span></th>
                <th>Task type</th>
                <th>Production Hours</th>
                <th>Task Details</th>
                <th>Project Status</th>                
              </tr>
              <?php if ($_REQUEST[basic_table] != 'true') { ?>
                <tr class="filterInput">
                  ...
                  <td><input type="text" name="project_hogarth_job_number" value="" class="search_init" /></td>
            ...
            <tbody>
              ...
              for ($i = 0; $i < $rows; $i++) {
                ...
                <tr id="<?php echo $arr[$i][uid]; ?>" >
                  ...
                  <td><?php echo $arr[$i][project_hogarth_job_number]; ?></td>
                  ...
                  <td><?php if (!strlen($arr[$i][time_activity_type])) {
                echo $arr[$i][project_activity_type];
              } else {
                echo $arr[$i][time_activity_type];
              } ?></td>
                ...
                echo $arr[$i][time_total];
                  ...
                  <td><?php if ($arr[$i][project_active] == '1') {
                echo "Active";
              } else {
                echo "Inactive";
              } ?></td>               
