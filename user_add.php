      ...
      <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="502" ><input name="user_name" type="text" value="<?php echo addEditInputField('user_name'); ?>" size="30" maxlength="30" class="validate[required],maxSize[20],minSize[5]]" <?php if($param!='add'){inputReadonly();}?>>
